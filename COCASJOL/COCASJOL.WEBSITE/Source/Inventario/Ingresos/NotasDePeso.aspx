...
<body>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="NotasDePesoDS" runat="server"
                ...
                DeleteMethod="EliminarTipoDeProducto" onselecting="NotasDePesoDS_Selecting" >
                <SelectParameters>
                ...
                <ext:Panel ID="Panel1" runat="server" Frame="false" Header="false" Title="Tipos de Producto" Icon="PageWhiteCup" Layout="Fit">
                    <Items>
                        <ext:GridPanel ID="TiposProductoGridP" runat="server" AutoExpandColumn="TIPOS_PROD_DESCRIPCION" Height="300"
                            ...
                            <Store>
                                <ext:Store ID="TiposDeProductoSt" runat="server" DataSourceID="NotasDePesoDS" AutoSave="true" SkipIdForNewRecords="false" >
                                    <Reader>
