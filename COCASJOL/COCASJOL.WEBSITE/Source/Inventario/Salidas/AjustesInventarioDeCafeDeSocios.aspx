...
<head runat="server">
    ...
    <script type="text/javascript" src="../../../resources/js/inventario/salidas/ajusteInventarioDeCafeDeSocio.js" ></script>
</head>
<body>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="AjusteInventarioDeCafeDs" runat="server"
                ...
                SelectMethod="GetAjustesDeInventarioDeCafe"
                InsertMethod="InsertarAjusteDeInventarioDeCafe" onselecting="AjusteInventarioDeCafeDs_Selecting" >
                <SelectParameters>
