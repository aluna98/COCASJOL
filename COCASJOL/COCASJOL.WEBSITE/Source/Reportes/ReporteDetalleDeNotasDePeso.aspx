<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteDetalleDeNotasDePeso.aspx.cs" Inherits="COCASJOL.WEBSITE.Source.Reportes.ReporteDetalleDeNotasDePeso" %>
...
<head id="Head1" runat="server">
    <title>Reporte Detalle de Notas de Peso</title>
...
<body>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="EstadosNotaDePesoDS" runat="server"
        ...
        <ext:Store ID="EstadosNotaDePesoSt" runat="server" DataSourceID="EstadosNotaDePesoDS">
            <Reader>
                                ...
                                <ext:Panel ID="AddSocioPnl" runat ="server" Layout="ColumnLayout" Border="false" AnchorHorizontal="100%" >
                                    ...
                                    <Items>
                                        <ext:Panel ID="Panel4" runat="server" Layout="AnchorLayout" Border="false" ColumnWidth=".5">
                                            <Items>
                                                <ext:ComboBox
                                                    ID="f_ESTADOS_NOTA_ID" FieldLabel="Estado" LabelAlign="Right" AnchorHorizontal="100%" LabelWidth="150"
                                                    runat="server"
                                                    AllowBlank="true"
                                                    ForceSelection="true"
                                                    StoreID="EstadosNotaDePesoSt"
                                        ...
                                        <ext:Panel ID="Panel1" runat="server" Layout="AnchorLayout" Border="false" ColumnWidth=".5" PaddingSummary="0 0 5 5">
                                            <Items>
                                                <ext:Checkbox runat="server" ID="g_ESTADOS_NOTA_ID" LabelWidth="200" LabelAlign="Left" FieldLabel="Agrupar por Estado" MsgTarget="Side" ></ext:Checkbox>
                                                ...
                                                <ext:Checkbox runat="server" ID="g_NOTAS_ID" LabelWidth="200" LabelAlign="Left" FieldLabel="Agrupar por Nota de Peso" MsgTarget="Side" ></ext:Checkbox>
                                            </Items>
                                        </ext:Panel>
                                    </Items>
                                </ext:Panel>
