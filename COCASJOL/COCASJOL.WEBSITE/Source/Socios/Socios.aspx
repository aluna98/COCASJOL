                        ...
                        <ext:GridPanel ID="SociosGridP" runat="server" Height="300"
                            ...
                            <Store>
                                <ext:Store ID="SociosSt" runat="server" SkipIdForNewRecords="false" AutoSave="false" WarningOnDirty="false" OnRefreshData="SociosSt_Reload">
                                    ...
                                    <DirectEvents>
                                        <Update OnEvent="SociosSt_Update">
                                            <ExtraParams>
                                ...
                                <ext:Toolbar ID="Toolbar1" runat="server">
                                    <Items>
                                        <ext:Button ID="Button1" runat="server" Text="Add" Icon="Add">
                                            <Listeners>
                                                <Click Handler="SocioX.add(); CompanyX.RefreshGrid()" />
                                            </Listeners>
                                        </ext:Button>
                                        <ext:Button ID="Button3" runat="server" Text="Edit" Icon="ApplicationEdit">
                                            <Listeners>
                                                <Click Handler="SocioX.edit(); CompanyX.RefreshGrid()" />
                                            </Listeners>
                                        </ext:Button>
                                    ...
                                    <Items>
                                        <ext:Panel ID="Panel13" runat="server" Frame="false" Padding="5" Layout="AnchorLayout" Border="false">
                                            <Items>
                                                ...
                                                <ext:TextField runat="server" ID="Edit1erNombreTxt"         DataIndex="SOCIOS_PRIMER_NOMBRE"         FieldLabel="Primer Nombre       "   AnchorHorizontal="90%" AllowBlank="false"   Vtype="alpha"></ext:TextField>
                                                <ext:TextField runat="server" ID="Edit2doNombreTxt"         DataIndex="SOCIOS_SEGUNDO_NOMBRE"        FieldLabel="Segundo Nombre      "   AnchorHorizontal="90%" AllowBlank="false"   Vtype="alpha"></ext:TextField>
                                                <ext:TextField runat="server" ID="Edit1erApellidoTxt"       DataIndex="SOCIOS_PRIMER_APELLIDO"       FieldLabel="Primer Apellido     "   AnchorHorizontal="90%" AllowBlank="false"   Vtype="alpha"></ext:TextField>
                                                <ext:TextField runat="server" ID="Edit2doApellidoTxt"       DataIndex="SOCIOS_SEGUNDO_APELLIDO"      FieldLabel="Segundo Apellido    "   AnchorHorizontal="90%" AllowBlank="false"   Vtype="alpha"></ext:TextField>
                                                <ext:TextField runat="server" ID="EditResidenciaTxt"        DataIndex="SOCIOS_RESIDENCIA"            FieldLabel="Residencia          "   AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                                <ext:TextField runat="server" ID="EditEstadoCivilTxt"       DataIndex="SOCIOS_ESTADO_CIVIL"          FieldLabel="Estado Civil        "   AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                                <ext:TextField runat="server" ID="EditLugarNacimientoTxt"   DataIndex="SOCIOS_LUGAR_DE_NACIMIENTO"   FieldLabel="Lugar de Nacimiento "   AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                                ...
                                                <ext:TextField runat="server" ID="EditNivelEducativoTxt"    DataIndex="SOCIOS_NIVEL_EDUCATIVO"       FieldLabel="Nivel Educativo     "   AnchorHorizontal="90%" AllowBlank="false"   MaxLength="5"></ext:TextField>
                                                <ext:TextField runat="server" ID="EditIdentidadTxt"         DataIndex="SOCIOS_IDENTIDAD"             FieldLabel="Tarjeta de Identidad"   AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                                <ext:TextField runat="server" ID="EditSocioProfesionTxt"    DataIndex="SOCIOS_PROFESION"             FieldLabel="Profesion           "   AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                                <ext:TextField runat="server" ID="EditSocioRTNTxt"          DataIndex="SOCIOS_RTN"                   FieldLabel="RTN                 "   AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                                <ext:TextField runat="server" ID="EditSocioTelfono"         DataIndex="SOCIOS_TELEFONO"              FieldLabel="Telefono            "   AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                                <ext:TextField runat="server" ID="EditLugarEmisionTxt"      DataIndex="SOCIOS_LUGAR_DE_EMISION"      FieldLabel="Lugar de Emision    "   AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                ...
                                <ext:Panel ID="PanelGrl" runat="server" Title="Datos Generales" Layout="AnchorLayout" AutoHeight="true" Icon="UserB">
                                    <Items>
                                        <ext:Panel ID="Panel2" runat="server" Frame="false" Padding="5" Layout="AnchorLayout" Border="false">
                                            <Items>
                                                <ext:TextField runat="server" ID="EditCarnetIhcafeTxt"  DataIndex="GENERAL_CARNET_IHCAFE"            FieldLabel="Carnet IHCAFE"   AnchorHorizontal="90%" />
                                                <ext:TextField runat="server" ID="EditOrgSecundTxt"     DataIndex="GENERAL_ORGANIZACION_SECUNDARIA"  FieldLabel="Org. Secundaria" AnchorHorizontal="90%" />
                                                <ext:TextField runat="server" ID="EditNumCarnetTxt"     DataIndex="GENERAL_NUMERO_CARNET"            FieldLabel="No. Carnet"      AnchorHorizontal="90%" />
                                                <ext:TextField runat="server" ID="EditEmpresaTxt"       DataIndex="GENERAL_EMPRESA_LABORA"           FieldLabel="Empresa"         AnchorHorizontal="90%" />
                                                <ext:TextField runat="server" ID="EditCargoTxt"         DataIndex="GENERAL_EMPRESA_CARGO"            FieldLabel="Cargo"           AnchorHorizontal="90%" />
                                                <ext:TextField runat="server" ID="EditDireccionTxt"     DataIndex="GENERAL_EMPRESA_DIRECCION"        FieldLabel="Direccion"       AnchorHorizontal="90%" />
                                                <ext:TextField runat="server" ID="EditTelefonoTxt"      DataIndex="GENERAL_EMPRESA_TELEFONO"         FieldLabel="Telefono"        AnchorHorizontal="90%" />
                                            </Items>
                                         </ext:Panel>
                                    </Items>
                                </ext:Panel>
                                    ...
                                    <Items>
                                        <ext:Panel ID="Panel5" runat="server" Frame="false" Padding="5" Layout="AnchorLayout" Border="false">
                                            <Items>
                                                ...
                                                <ext:TextField runat="server" ID="Add1erNombreTxt"          DataIndex="SOCIOS_PRIMER_NOMBRE"        FieldLabel="Primer Nombre"          AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                                <ext:TextField runat="server" ID="Add2doNombreTxt"          DataIndex="SOCIOS_SEGUNDO_NOMBRE"       FieldLabel="Segundo Nombre"         AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                                <ext:TextField runat="server" ID="Add1erApellidoTxt"        DataIndex="SOCIOS_PRIMER_APELLIDO"      FieldLabel="Primer Apellido"        AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                                <ext:TextField runat="server" ID="Add2doApellidoTxt"        DataIndex="SOCIOS_SEGUNDO_APELLIDO"     FieldLabel="Segundo Apellido"       AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                                <ext:TextField runat="server" ID="AddResidenciaTxt"         DataIndex="SOCIOS_RESIDENCIA"           FieldLabel="Residencia"             AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                                <ext:TextField runat="server" ID="AddEstadoCivilTxt"        DataIndex="SOCIOS_ESTADO_CIVIL"         FieldLabel="Estado Civil"           AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                                <ext:TextField runat="server" ID="AddLugarNacTxt"           DataIndex="SOCIOS_LUGAR_DE_NACIMIENTO"  FieldLabel="Lugar de Nacimiento"    AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                                ...
                                                <ext:TextField runat="server" ID="AddNivelEducTxt"          DataIndex="SOCIOS_NIVEL_EDUCATIVO"      FieldLabel="Nivel Educativo"        AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                                <ext:TextField runat="server" ID="AddIdentidadTxt"          DataIndex="SOCIOS_IDENTIDAD"            FieldLabel="Tarjeta de Identidad"   AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                                <ext:TextField runat="server" ID="AddProfesionTxt"          DataIndex="SOCIOS_PROFESION"            FieldLabel="Profesion"              AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                                <ext:TextField runat="server" ID="AddRTNTxt"                DataIndex="SOCIOS_RTN"                  FieldLabel="RTN"                    AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                                <ext:TextField runat="server" ID="AddTelefonoTxt"           DataIndex="SOCIOS_TELEFONO"             FieldLabel="Telefono"               AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                                <ext:TextField runat="server" ID="AddLugarEmisionTxt"       DataIndex="SOCIOS_LUGAR_DE_EMISION"     FieldLabel="Lugar de Emision"       AnchorHorizontal="90%" AllowBlank="false"   ></ext:TextField>
                                ...
                                <ext:Panel ID="PanelGeneral" runat="server" Title="Datos Generales" Layout="AnchorLayout" AutoHeight="true" Icon="UserB">
                                    <Items>
                                        <ext:Panel ID="Panel7" runat="server" Frame="false" Padding="5" Layout="AnchorLayout" Border="false">
                                            <Items>
                                                <ext:TextField runat="server" ID="AddCarnetIHCAFETxt"       DataIndex="GENERAL_CARNET_IHCAFE"           FieldLabel="Carnet IHCAFE"   AnchorHorizontal="90%" />
                                                <ext:TextField runat="server" ID="AddOrganizacionSecunTxt"  DataIndex="GENERAL_ORGANIZACION_SECUNDARIA" FieldLabel="Org. Secundaria" AnchorHorizontal="90%" />
                                                <ext:TextField runat="server" ID="AddNumCarnetTxt"          DataIndex="GENERAL_NUMERO_CARNET"           FieldLabel="No. Carnet"      AnchorHorizontal="90%" />
                                                <ext:TextField runat="server" ID="AddEmpresaTxt"            DataIndex="GENERAL_EMPRESA_LABORA"          FieldLabel="Empresa"         AnchorHorizontal="90%" />
                                                <ext:TextField runat="server" ID="AddCargoTxt"              DataIndex="GENERAL_EMPRESA_CARGO"           FieldLabel="Cargo"           AnchorHorizontal="90%" />
                                                <ext:TextField runat="server" ID="AddDireccionTxt"          DataIndex="GENERAL_EMPRESA_DIRECCION"       FieldLabel="Direccion"       AnchorHorizontal="90%" />
                                                <ext:TextField runat="server" ID="AddEmpresaTelefonoTxt"    DataIndex="GENERAL_EMPRESA_TELEFONO"        FieldLabel="Telefono"        AnchorHorizontal="90%" />
                                            </Items>
                                         </ext:Panel>
                                    </Items>
                                </ext:Panel>
